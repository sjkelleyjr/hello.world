(module
 ...
 (data (i32.const 128) "INFO \00")
 (data (i32.const 144) "user: \00")
 (data (i32.const 160) " @ \00")
 (data (i32.const 176) ":\00")
 (data (i32.const 192) "hello.world.cpp\00")
 (data (i32.const 208) " \00")
 (data (i32.const 224) "[\00")
 (data (i32.const 240) "]\00")
 (data (i32.const 256) "(\00")
 (data (i32.const 272) "hi\00")
 (data (i32.const 288) ")\n\00")
 (data (i32.const 304) "Hello, \00")
